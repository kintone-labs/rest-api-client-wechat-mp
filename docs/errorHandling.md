...
When the API request responds with a status code other than 200, the client raises [`KintoneRestAPIError`](https://github.com/kintone/js-sdk/blob/master/packages/rest-api-client/src/KintoneRestAPIError.ts).

[`KintoneRestAPIError`](https://github.com/kintone/js-sdk/blob/master/packages/rest-api-client/src/KintoneRestAPIError.ts) has the following properties:
